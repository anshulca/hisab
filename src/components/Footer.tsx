...
function legalLink(onNavigate?: (s: string) => void, tab = 'faq') {
  return (e: { preventDefault: () => void }) => {
    e.preventDefault();
    onNavigate?.(`legal:${tab}`);
  };
}
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <a href="#faq" onClick={legalLink(onNavigate, 'faq')}>FAQ</a>
          </div>

          <div className="footer-col">
            <h4>Legal</h4>
            <a href="#privacy" onClick={legalLink(onNavigate, 'privacy')}>Privacy Policy</a>
            <a href="#terms" onClick={legalLink(onNavigate, 'terms')}>Terms</a>
            <a href="#disclaimer" onClick={legalLink(onNavigate, 'disclaimer')}>Disclaimer</a>
