...
interface I3ReviewCentreProps {
  onNavigate: (section: string) => void;
}

export function I3ReviewCentre({ onNavigate }: I3ReviewCentreProps) {
    ...
    return (
      <div className="section">
        <div className="container" style={{ textAlign: 'center', padding: 80 }}>
          ...
          <p className="section-sub" style={{ margin: '12px 0 24px' }}>Upload an ITR-3 JSON file to generate the computation.</p>
  ...
  const regimeLabel = taxpayer.regime === 'old' ? 'Old Regime' : 'New Regime';
    ...
    <div className="section">
      <div className="container">
        ...
        <div className="section-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 14 }}>
          <div>
            <h2 className="section-title">Review Centre — ITR-3</h2>
            <p className="section-sub">
              <span className="hero-badge" style={{ fontSize: '0.55rem', marginRight: 8 }}>
                <i className="fas fa-check-circle" style={{ fontSize: '0.4rem' }} /> {itrForm === 'ITR3' ? 'ITR-3 DETECTED' : itrForm}
              </span>
            ...
            <div className="table-wrap" style={{ marginTop: 14 }}>
              <table className="mini-table">
                <tbody>
                  ...
                  {d.income.business !== 0 && <tr><td>Business / Profession</td><td style={{ textAlign: 'right' }}>{formatINR(d.income.business)}</td></tr>}
        ...
        <div className="card" style={{ marginTop: 20 }}>
          ...
          <p className="card-sub">Open any section of the ITR-3 working file.</p>
