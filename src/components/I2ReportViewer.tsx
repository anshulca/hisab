    ...
    <div className="section">
      <div className="container">
        <div className="section-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 14 }}>
          <div>
            <h2 className="section-title">ITR-2 Computation Report</h2>
            <p className="section-sub">
              {report.header.name} · PAN {maskPan(report.header.pan)} · AY {report.header.assessmentYear} · {report.header.regime}
            </p>
          </div>
